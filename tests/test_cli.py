...
def test_source_add_wizard(runner, store):
    # Simulate wizard: pick type 15 (wise), name "wise-main", token "my-token"
    # Type list is sorted, so wise is at position 15
    input_text = "15\nwise-main\nmy-token\n"
...
def test_source_add_with_defaults(runner, store):
    ...
    # bybit=5, emcd=6, ibkr=7, kbank=8, lobstr=9, mexc=10, mexc_earn=11, okx=12, rabby=13, revolut=14, wise=15, yo=16.
